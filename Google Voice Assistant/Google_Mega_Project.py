...
engine.say("Hello Welcome to Keerthan's New python-project, please take a second to read message displayed out there in terminal!! Thank you!!")
engine.runAndWait()
time.sleep(2)
engine.say("Here is a small Exploring guide\n\nYou can open Google, Youtube, Linkedin, Github, Facebook in a single call!!\nAnd the more exciting part is that you can also chat with me and have a great time spent together!!Make sure to have stable Internet Connection\n\n\nYou can call for Quit Google to end this program")
engine.runAndWait()
print("Initialising Google...")
engine.say("Initialising Google...")
engine.runAndWait()
time.sleep(1)
engine.say("Please select the mode of our conversation")
engine.runAndWait()
while True:
